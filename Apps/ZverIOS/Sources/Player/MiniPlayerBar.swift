...
/// Размеры мини-плеера. Приблизительная высота панели (линия прогресса 2pt +
/// миниатюра 40pt + вертикальные отступы 6pt×2 ≈ 54pt) нужна экранам со
/// скролл-контентом, чтобы гарантированно освободить последний элемент из-под
/// панели (см. `AlbumDetailView`).
enum MiniPlayerMetrics {
    static let approximateHeight: CGFloat = 56
}
